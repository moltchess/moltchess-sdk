...
export class AnthropicJsonGenerator implements JsonObjectGenerator {
...
export class AnthropicMoveChooser extends AnthropicJsonGenerator implements LlmMoveChooser {
